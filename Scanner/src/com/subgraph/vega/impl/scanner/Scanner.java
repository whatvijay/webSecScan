...
public class Scanner implements IScanner {
	...
	public IScan createScan() {
		 try {
			 ITargetScopeManager itsm=currentWorkspace.getTargetScopeManager();
					 itsm.createNewScope().addScopeURI(new URI("https://www.hackthissite.org"));
		} catch (URISyntaxException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		//currentWorkspace.getTargetScopeManager().
